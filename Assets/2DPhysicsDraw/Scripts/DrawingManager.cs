...
public class DrawingManager : MonoBehaviour
{
    ...
    [SerializeField] private List<Vector2> newVerticies_ = new List<Vector2>();
    ...
    public ColliderTypeChoices colliderType; //choose between Polygon Collider 2D or Edge Collider 2D
                                             // *Obs: be aware that Edge Collider 2D don't collide with each other
    ...
    void Start()
    {
        ...
        // Setting up line renderer, the material can be modified
        ...
        // v4.1 -Default values not being set on Start method
        // Example seting values
        /* ---
    ...
    void FixedUpdate()
    {
        ...
        mousePointer.GetComponent<TargetJoint2D>().target = ball.position;
    ...
    public void TriggerMouseDown()
    {
        ...
        if (canDraw == true)
        {
            ...
            mousePointer.transform.position = ball.position;
    ...
    {        
        ...
        if (canDraw && (lenghLimit == 0 || lineLength < lenghLimit)) //V4.0.2
        {
